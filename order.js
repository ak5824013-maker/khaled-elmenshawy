...
// نفس منطق استقبال الأوردر وإرساله على تليجرام، بس بصيغة Cloudflare Pages Functions
// (مفيش سيرفر Node عادي هنا - الملف ده بيتشغل تلقائي لما حد يبعت POST على /api/order).
